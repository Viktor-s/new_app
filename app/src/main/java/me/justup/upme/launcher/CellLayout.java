...
/**
 * Контейнер для отображения виджетов и иконок приложения
 */
public class CellLayout extends ViewGroup {
    private static final String TAG = CellLayout.class.getSimpleName();

    private LauncherActivity mMainActivity;
    ...
    private TimeInterpolator mEaseOutInterpolator = null;
    private ShortcutAndWidgetContainer mShortcutsAndWidgets = null;
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMainActivity = (LauncherActivity) context;
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (outline == null) {
                        ...
                        if (debug) {
                            ...
                            LOGD(TAG, "anim " + thisIndex + " update: " + val +
    ...
    private void commitTempPlacement() {
        ...
        mMainActivity.getWorkspace().updateItemLocationsInDatabase(this);
    }
