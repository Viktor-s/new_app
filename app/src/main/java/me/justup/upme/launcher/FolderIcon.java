...
/**
 * Folder An icon that can appear on in the
...
public class FolderIcon extends LinearLayout implements FolderInfo.FolderListener {
    private LauncherActivity mMainActivity = null;

    public Folder mFolder = null;
    public FolderInfo mInfo = null;
    ...
    public static FolderIcon fromXml(int resId, LauncherActivity launcher, ViewGroup group, FolderInfo folderInfo, IconCache iconCache) {
    ...
    public static class FolderRingAnimator {
        ...
        public FolderRingAnimator(LauncherActivity mainActivity, FolderIcon folderIcon) {
    ...
    private void onDrop(final ShortcutInfo item, DragView animateView,
                        ...
                        Runnable postAnimationRunnable, DropTarget.DragObject d) {
        ...
        if (animateView != null) {
            DragLayer dragLayer = mMainActivity.getDragLayer();
            Rect from = new Rect();
            dragLayer.getViewRectRelativeToSelf(animateView, from);
            Rect to = finalRect;
            if (to == null) {
                to = new Rect();
                Workspace workspace = mMainActivity.getWorkspace();
