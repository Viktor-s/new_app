...
public class Folder extends LinearLayout implements DragSource,
    ...
    protected CellLayout mContent = null;
    ...
    private ShortcutInfo mCurrentDragInfo = null;
    ...
    FolderEditText mFolderName = null;
    ...
    private static String sHintText = null;
    private ObjectAnimator mOpenCloseAnimator = null;
            ...
            public void onAnimationStart(Animator animation) {
                sendCustomAccessibilityEvent(
                        AccessibilityEvent.TYPE_WINDOW_STATE_CHANGED, String
                                .format(getContext().getString(R.string.folder_opened),
                                        mContent.getCountX(),
                                        mContent.getCountY()));
    ...
    protected boolean createAndAddShortcut(ShortcutInfo item) {
        ...
        if (mContent.getChildAt(item.cellX, item.cellY) != null
            ...
            LOGE(TAG, "Folder order not properly persisted during bind");
