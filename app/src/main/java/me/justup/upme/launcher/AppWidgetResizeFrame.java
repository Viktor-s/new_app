...
public class AppWidgetResizeFrame extends FrameLayout {
    private static final String TAG = AppWidgetResizeFrame.class.getSimpleName();

    private LauncherAppWidgetHostView mWidgetView = null;
    ...
    public AppWidgetResizeFrame(Context context,
        ...
        int[] result = LauncherActivity.getMinSpanForWidget(mLauncher, info);
        mMinHSpan = result[0];
        mMinVSpan = result[1];
    ...
    static void updateWidgetSizeRanges(AppWidgetHostView widgetView,
                                       LauncherActivity launcher, int spanX, int spanY) {
    ...
    static Rect getWidgetSizeRanges(LauncherActivity launcher, int spanX, int spanY,
                                    Rect rect) {
        if (rect == null) {
            rect = new Rect();
        }
