...
public class AppsCustomizeTabHost extends TabHost implements
        LauncherActivity.LauncherTransitionable, TabHost.OnTabChangeListener {
    private static final String TAG = AppsCustomizeTabHost.class.getSimpleName();
	...
	private ViewGroup mTabsContainer = null;
	private AppsCustomizePagedView mAppsCustomizePane = null;
	private FrameLayout mAnimationBuffer = null;
	private LinearLayout mContent = null;

	private boolean mInTransition;
	private boolean mTransitioningToWorkspace;
	private boolean mResetAfterTransition;
	private Runnable mRelayoutAndMakeVisible = null;
	...
	@Override
	public void onLauncherTransitionPrepare(LauncherActivity l, boolean animated,
			boolean toWorkspace) {
		mAppsCustomizePane
	...
	@Override
	public void onLauncherTransitionStart(LauncherActivity l, boolean animated,
			boolean toWorkspace) {
		if (animated) {
	...
	@Override
	public void onLauncherTransitionEnd(LauncherActivity l, boolean animated,
			boolean toWorkspace) {
