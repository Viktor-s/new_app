...
public class AppsCustomizePagedView extends PagedViewWithDraggableItems implements
        ...
        LauncherActivity.LauncherTransitionable {
    private static final String TAG = AppsCustomizePagedView.class.getSimpleName();
    ...
    private PagedViewIcon mPressedIcon = null;

    // Content
    private ArrayList<ApplicationInfo> mApps = null;
    ...
    private PagedViewCellLayout mWidgetSpacingLayout = null;
    ...
    private Toast mWidgetInstructionToast = null;
    ...
    public AppsCustomizePagedView(Context context, AttributeSet attrs) {
        ...
        mIconCache = ((JustUpApplication) context.getApplicationContext()).getIconCache();
        mCanvas = new Canvas();
    ...
    public void onPackagesUpdated() {
        ...
        for (AppWidgetProviderInfo widget : widgets) {
            if (widget.minWidth > 0 && widget.minHeight > 0) {
                ...
                int[] spanXY = LauncherActivity.getSpanForWidget(mLauncher, widget);
                int[] minSpanXY = LauncherActivity.getMinSpanForWidget(mLauncher, widget);
                ...
                if (minSpanX <= LauncherModel.getCellCountX() &&
                    ...
                    LOGE(TAG, "Widget " + widget.provider + " can not fit on this device (" +
                            widget.minWidth + ", " + widget.minHeight + ")");
                }
            } else {
                LOGE(TAG, "Widget " + widget.provider + " has invalid dimensions (" +
                        widget.minWidth + ", " + widget.minHeight + ")");
            }
        }
    ...
    Bundle getDefaultOptionsForWidget(LauncherActivity launcher, PendingAddWidgetInfo info) {
        Bundle options = null;
    ...
    private Bitmap getWidgetPreview(ComponentName provider, int previewImage,
        ...
        if (previewImage != 0) {
            ...
            if (drawable == null) {
                LOGI(TAG, "Can't load widget preview drawable 0x" +
    ...
    public void syncWidgetPageItems(final int page, final boolean immediate) {
        ...
        for (int i = 0; i < items.size(); ++i) {
            ...
            if (rawInfo instanceof AppWidgetProviderInfo) {
                ...
                int[] spanXY = LauncherActivity.getSpanForWidget(mLauncher, info);
                createItemInfo.spanX = spanXY[0];
                createItemInfo.spanY = spanXY[1];
                int[] minSpanXY = LauncherActivity.getMinSpanForWidget(mLauncher, info);
    ...
    private void loadWidgetPreviewsInBackground(AppsCustomizeAsyncTask task,
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (rawInfo instanceof AppWidgetProviderInfo) {
                AppWidgetProviderInfo info = (AppWidgetProviderInfo) rawInfo;
                int[] cellSpans = LauncherActivity.getSpanForWidget(mLauncher, info);
     ...
     */
    public void setup(LauncherActivity launcher, DragController dragController) {
        mLauncher = launcher;
