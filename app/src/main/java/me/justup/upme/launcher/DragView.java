...
public class DragView extends View {
    ...
    private Bitmap mCrossFadeBitmap = null;
     ...
     * <p>
     *
     * @param mainActivity The Launcher instance
     * @param bitmap The view that we're dragging around. We scale it up when we draw it.
     * @param registrationX The x coordinate of the registration point.
     * @param registrationY The y coordinate of the registration point.
     */
    public DragView(LauncherActivity mainActivity, Bitmap bitmap, int registrationX,
                    int registrationY, int left, int top, int width, int height,
                    final float initialScale) {
        super(mainActivity);
        mDragLayer = mainActivity.getDragLayer();
