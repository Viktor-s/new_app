...
public class PagedViewWidget extends LinearLayout {
    private static final String TAG = PagedViewWidget.class.getSimpleName();

    private static boolean sDeletePreviewsWhenDetachedFromWindow = true;

    private String mDimensionsFormatString = null;
    CheckForShortPress mPendingCheckForShortPress = null;
    public ShortPressListener mShortPressListener = null;
