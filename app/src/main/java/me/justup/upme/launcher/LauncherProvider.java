...
public class LauncherProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.android.launcher22.settings";
    ...
    public boolean onCreate() {
        ...
        ((JustUpApplication) getContext()).setLauncherProvider(this);
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        DatabaseHelper(Context context) {
            ...
            mContext = context;
            mAppWidgetHost = new AppWidgetHost(context, LauncherActivity.APPWIDGET_HOST_ID);
        ...
        public void onCreate(SQLiteDatabase db) {
            LOGI(TAG, "creating new launcher database");
        ...
        private boolean convertDatabase(SQLiteDatabase db) {
            LOGI(TAG, "Converting database from an older format, but not onUpgrade");
            ...
            if (converted) {
                ...
                LOGI(TAG, "Converted and now triggering widget upgrade");
                convertWidgets(db);
            }
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (version != DATABASE_VERSION) {
                LOGD(TAG, "Destroying all old data.");
        ...
        private boolean updateContactsShortcuts(SQLiteDatabase db) {
            final String selectWhere = buildOrWhereString(LauncherSettings.Favorites.ITEM_TYPE, new int[] { LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT });
            ...
            try {
                ...
                c = db.query(TABLE_FAVORITES, new String[] { LauncherSettings.Favorites._ID, LauncherSettings.Favorites.INTENT }, selectWhere, null, null, null, null);
                if (c == null) return false;

                LOGD(TAG, "Found upgrade cursor count=" + c.getCount());
                ...
                while (c.moveToNext()) {
                    ...
                    if (intentUri != null) {
                        try {
                            ...
                            LOGD(TAG, "Intent : " + intent.toString());
                            ...
                            if (uri != null) {
                                ...
                                if ((Intent.ACTION_VIEW.equals(intent.getAction()) ||
                                    ...
                                    newIntent.putExtra(LauncherActivity.INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION, true);
                            ...
                            LOGE(TAG, "Problem upgrading shortcut", ex);
                        }
                    }
                }
                ...
                LOGE(TAG, "Problem while upgrading contacts", ex);
                return false;
            } finally {
                db.endTransaction();
                if (c != null) {
        ...
        private void normalizeIcons(SQLiteDatabase db) {
            ...
            try {
                ...
                c = db.rawQuery("SELECT _id, icon FROM favorites WHERE iconType=" + LauncherSettings.Favorites.ICON_TYPE_BITMAP, null);
                ...
                while (c.moveToNext()) {
                    ...
                    try {
                        ...
                        if (!logged) {
                            LOGE(TAG, "Failed normalizing icon " + id, e);
                        } else {
                            LOGE(TAG, "Also failed normalizing icon " + id);
                        }
                ...
                LOGE(TAG, "Problem while allocating appWidgetIds for existing widgets", ex);
            } finally {
                db.endTransaction();
                if (update != null) {
                    update.close();
            ...
            try {
                ...
                while (c != null && c.moveToNext()) {
                    ...
                    try {
                        ...
                        LOGD(TAG, "Allocated appWidgetId=" + appWidgetId + " for favoriteId=" + favoriteId);
                        ...
                        LOGE(TAG, "Problem allocating appWidgetId", ex);
                    }
                }
            ...
            try {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG ||
                    ...
                    if (TAG_FAVORITE.equals(name)) {
                        ...
                        String title;
                        int titleResId =  a.getResourceId(R.styleable.Favorite_title_fav, -1);
                        if (titleResId != -1) {
                ...
                LOGE(TAG, "Got exception parsing favorites.", e);
            }
        ...
        private long addAppShortcut(SQLiteDatabase db, ContentValues values, TypedArray a, PackageManager packageManager, Intent intent) {
            ...
            try {
                ...
                LOGE(TAG, "Unable to add favorite: " + packageName + "/" + className, e);
            }
        ...
        private long addUriShortcut(SQLiteDatabase db, ContentValues values, TypedArray a) {
            ...
            final int iconResId = a.getResourceId(R.styleable.Favorite_icon_fav, 0);
            final int titleResId = a.getResourceId(R.styleable.Favorite_title_fav, 0);
            ...
            try {
                ...
                LOGE(TAG, "Shortcut has malformed uri: " + uri);

                return -1; // Oh well
            }

            if (iconResId == 0 || titleResId == 0) {
                LOGI(TAG, "Shortcut is missing title or icon resource ID");
