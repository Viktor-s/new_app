...
public class Workspace extends SmoothPagedView implements DropTarget,
        ...
        DragController.DragListener, LauncherActivity.LauncherTransitionable,
    ...
    private ObjectAnimator mChildrenOutlineFadeInAnimation = null;
    private ObjectAnimator mChildrenOutlineFadeOutAnimation = null;
    private float mChildrenOutlineAlpha = 0;

    // These properties refer to the background protection gradient used for
    // AllApps and Customize
    private ValueAnimator mBackgroundFadeInAnimation = null;
    private ValueAnimator mBackgroundFadeOutAnimation = null;
    ...
    private SpringLoadedDragController mSpringLoadedDragController = null;
    ...
    WallpaperOffsetInterpolator mWallpaperOffset = null;
    ...
    private DropTarget.DragEnforcer mDragEnforcer = null;
    ...
    private SparseArray<Parcelable> mSavedStates = null;
    ...
    protected void initWorkspace() {
        ...
        LauncherActivity.setScreen(mCurrentPage);
    ...
    protected boolean shouldDrawChild(View child) {
        ...
        return super.shouldDrawChild(child) && (cl.getShortcutsAndWidgets().getAlpha() > 0 || cl.getBackgroundAlpha() > 0);
    }
    ...
    public void addInScreen(View child, long container, int screen, int x, int y, int spanX, int spanY, boolean insert) {
        if (container == LauncherSettings.Favorites.CONTAINER_DESKTOP) {
            if (screen < 0 || screen >= getChildCount()) {
                LOGE(TAG, "The screen must be >= 0 and < " + getChildCount() + " (was " + screen + "); skipping child");
                return;
            }
        }
        ...
        if (!layout.addViewToCellLayout(child, insert ? 0 : -1, childId, lp, markCellsAsOccupied)) {
            ...
            LOGE(TAG, "Failed to add to item at (" + lp.cellX + "," + lp.cellY + ") to CellLayout");
        }
    ...
    private boolean hitsPage(int index, float x, float y) {
        ...
        if (page != null) {
            ...
            return (localXY[0] >= 0 && localXY[0] < page.getWidth() && localXY[1] >= 0 && localXY[1] < page.getHeight());
        }
    ...
    protected boolean hitsPreviousPage(float x, float y) {
        ...
        return JustUpApplication.isScreenLarge() && hitsPage(current - 1, x, y);
    }
    ...
    private float wallpaperOffsetForCurrentScroll() {
        ...
        if (JustUpApplication.isScreenLarge() && mIsStaticWallpaper) {
    ...
    class WallpaperOffsetInterpolator {
        ...
        public boolean computeScrollOffset() {
            ...
            // devices
            if (!JustUpApplication.isScreenLarge() || jumpToFinalValue) {
    ...
    @Override
    public void onLauncherTransitionPrepare(LauncherActivity l, boolean animated, boolean toWorkspace) {
        mIsSwitchingState = true;
        cancelScrollingIndicatorAnimations();
    }

    @Override
    public void onLauncherTransitionStart(LauncherActivity l, boolean animated, boolean toWorkspace) {
    }

    @Override
    public void onLauncherTransitionStep(LauncherActivity l, float t) {
        mTransitionProgress = t;
    }

    @Override
    public void onLauncherTransitionEnd(LauncherActivity l, boolean animated, boolean toWorkspace) {
    ...
    public void addApplicationShortcut(ShortcutInfo info, CellLayout target,
    ...
    public boolean willAddToExistingUserFolder(Object dragInfo, CellLayout target,
    ...
    public boolean createUserFolderIfNecessary(View newView, long container,
    ...
    public boolean addToExistingFolderIfNecessary(View newView, CellLayout target,
    ...
    // After icon drag and drop
    public void onDrop(final DragObject d) {
        LOGD(TAG, "X coordinate : " + String.valueOf(d.x));
    ...
    static Rect getCellLayoutMetrics(LauncherActivity launcher, int orientation) {
    ...
    class FolderCreationAlarmListener implements OnAlarmListener {
        ...
        public void onAlarm(Alarm alarm) {
            if (mDragFolderRingAnimator == null) {
                mDragFolderRingAnimator = new FolderIcon.FolderRingAnimator(mLauncher,
                        null);
            }
    ...
    public Bitmap createWidgetBitmap(ItemInfo widgetInfo, View layout) {
        ...
        int width = View.MeasureSpec.makeMeasureSpec(unScaledSize[0],
                View.MeasureSpec.EXACTLY);
        int height = View.MeasureSpec.makeMeasureSpec(unScaledSize[1],
                View.MeasureSpec.EXACTLY);
    ...
    public boolean onEnterScrollArea(int x, int y, int direction) {
        ...
        boolean isPortrait = !JustUpApplication
    ...
    public void removeItems(final ArrayList<String> packages) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                String spKey = JustUpApplication.getSharedPreferencesKey();
