...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    private PageSwitchListener mPageSwitchListener = null;

    protected ArrayList<Boolean> mDirtyPageContent = null;
    ...
    // Scrolling indicator
    private ValueAnimator mScrollIndicatorAnimator = null;
    private View mScrollIndicator = null;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LOGD(TAG, "PagedView.onMeasure(): " + widthSize + ", " + heightSize);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            LOGD(TAG,"\tmeasure-child" + i + ": " + child.getMeasuredWidth() + ", " + child.getMeasuredHeight());
        }
        ...
        if (childCount > 0) {
            LOGD(TAG, "getRelativeChildOffset(): " + getMeasuredWidth() + ", " + getChildWidth(0));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != View.GONE) {
                ...
                LOGD(TAG, "\tlayout-child" + i + ": " + childLeft + ", " + childTop);
                ...
                if (mTouchState == TOUCH_STATE_SCROLLING) {
                    ...
                    if (Math.abs(deltaX) >= 1.0f) {
                        ...
                        if (!mDeferScrollUpdate) {
                            ...
                            LOGD(TAG, "onTouchEvent().Scrolling: " + deltaX);
                        } else {
                            invalidate();
                        }
    ...
    protected void snapToPageWithVelocity(int whichPage, int velocity) {
        ...
        LOGD(TAG, "snapToPage.getChildOffset(): " + getChildOffset(whichPage));
        LOGD(TAG, "snapToPageWithVelocity.getRelativeChildOffset(): " + getMeasuredWidth() + ", " + getChildWidth(whichPage));
    ...
    protected void snapToPage(int whichPage, int duration) {
        ...
        LOGD(TAG, "snapToPage.getChildOffset(): " + getChildOffset(whichPage));
        LOGD(TAG, "snapToPage.getRelativeChildOffset(): " + getMeasuredWidth() + ", " + getChildWidth(whichPage));
    ...
    /**
     * Set true to allow long-press events to be triggered, usually checked by to accept or block dpad-initiated long-presses.
     */
    ...
    protected void loadAssociatedPages(int page, boolean immediateAndOnly) {
        if (mContentIsRefreshable) {
            ...
            if (page < count) {
                ...
                LOGD(TAG, "loadAssociatedPages: " + lowerPageBound + "/" + upperPageBound);
