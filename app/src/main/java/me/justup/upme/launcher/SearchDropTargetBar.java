...
public class SearchDropTargetBar extends FrameLayout implements DragController.DragListener {
    ...
    private ObjectAnimator mDropTargetBarAnim = null;
    private ObjectAnimator mQSBSearchBarAnim = null;
    private static final AccelerateInterpolator sAccelerateInterpolator =
            new AccelerateInterpolator();

    private boolean mIsSearchBarHidden;
    private View mQSBSearchBar = null;
    private View mDropTargetBar = null;
    private ButtonDropTarget mInfoDropTarget = null;
    private ButtonDropTarget mDeleteDropTarget = null;
