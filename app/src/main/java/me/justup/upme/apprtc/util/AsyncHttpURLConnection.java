...
public class AsyncHttpURLConnection {
    private static final String TAG = AsyncHttpURLConnection.class.getSimpleName();

    private static final int HTTP_TIMEOUT_MS = 16000; // 8000
    private static final String HTTP_ORIGIN = Constance.SERVER_ADDRESS;
    private String method = null;
    private String url = null;
    private String message = null;
    private AsyncHttpEvents events = null;
    ...
    private void sendHttpMessage() {
        try {
            ...
            // TODO - query request origin from pref_room_server_url_key preferences.
