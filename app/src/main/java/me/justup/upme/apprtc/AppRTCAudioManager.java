...
import me.justup.upme.apprtc.util.AppRTCUtils;
...
public class AppRTCAudioManager {
    ...
    private Context apprtcContext = null;
    private Runnable onStateChangeListener = null;
    ...
    // TODO : it is possible that EARPIECE should be preferred in some
    ...
    private BroadcastReceiver wiredHeadsetReceiver = null;
    ...
    public void setAudioDevice(AudioDevice device) {
        LOGD(TAG, "setAudioDevice(device = " + device + ")");
        ...
        switch (device) {
            ...
            case WIRED_HEADSET:
                ...
                break;
            default:
                LOGE(TAG, "Invalid audio device selection");
                break;
        }
    ...
    private void registerForWiredHeadsetIntentBroadcast() {
        ...
        wiredHeadsetReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                LOGD(TAG, "BroadcastReceiver.onReceive" + AppRTCUtils.getThreadInfo()
                        + ": "
                        + "a=" + intent.getAction()
    ...
    private void updateAudioDeviceState(boolean hasWiredHeadset) {
        ...
        LOGD(TAG, "AudioDevices : " + audioDevices);
    ...
    private void onAudioManagerChangedState() {
        LOGD(TAG, "onAudioManagerChangedState : devices=" + audioDevices
