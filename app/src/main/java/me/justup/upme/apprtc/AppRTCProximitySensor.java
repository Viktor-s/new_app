...
public class AppRTCProximitySensor implements SensorEventListener {
    ...
    private Runnable onSensorStateListener = null;
    ...
    private AppRTCProximitySensor(Context context, Runnable sensorStateListener) {
        LOGD(TAG, "AppRTCProximitySensor" + AppRTCUtils.getThreadInfo());
    ...
    public boolean start() {
        ...
        LOGD(TAG, "start" + AppRTCUtils.getThreadInfo());
    ...
    public void stop() {
        checkIfCalledOnValidThread();
        LOGD(TAG, "stop" + AppRTCUtils.getThreadInfo());
    ...
    public final void onAccuracyChanged(Sensor sensor, int accuracy) {
        ...
        if (accuracy == SensorManager.SENSOR_STATUS_UNRELIABLE) {
            LOGE(TAG, "The values returned by this sensor cannot be trusted");
        }
    }
    ...
    public final void onSensorChanged(SensorEvent event) {
        ...
        if (distanceInCentimeters < proximitySensor.getMaximumRange()) {
            LOGD(TAG, "Proximity sensor => NEAR state");
            lastStateReportIsNear = true;
        } else {
            LOGD(TAG, "Proximity sensor => FAR state");
        ...
        LOGD(TAG, "onSensorChanged" + AppRTCUtils.getThreadInfo() + ": "
