...
public class WebRtcClient {
    ...
    private final static String TAG = "TAG_WebRtcClient";
    ...
    public void setCamera(String cameraFacing, String height, String width) {
        ...
        lMS.addTrack(factory.createAudioTrack("ARDAMSa0", factory.createAudioSource(videoConstraints)));
