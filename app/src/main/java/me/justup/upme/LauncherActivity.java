...
import me.justup.upme.launcher.ApplicationInfo;
import me.justup.upme.launcher.AppsCustomizePagedView;
import me.justup.upme.launcher.AppsCustomizeTabHost;
import me.justup.upme.launcher.BubbleTextView;
import me.justup.upme.launcher.CellLayout;
import me.justup.upme.launcher.Cling;
import me.justup.upme.launcher.DragController;
import me.justup.upme.launcher.DragLayer;
import me.justup.upme.launcher.DragView;
import me.justup.upme.launcher.DropTarget;
import me.justup.upme.launcher.Folder;
import me.justup.upme.launcher.FolderIcon;
import me.justup.upme.launcher.FolderInfo;
import me.justup.upme.launcher.HideFromAccessibilityHelper;
import me.justup.upme.launcher.HolographicImageView;
import me.justup.upme.launcher.HolographicLinearLayout;
import me.justup.upme.launcher.Hotseat;
import me.justup.upme.launcher.IconCache;
import me.justup.upme.launcher.InstallShortcutReceiver;
import me.justup.upme.launcher.ItemInfo;
import me.justup.upme.launcher.LauncherAnimUtils;
import me.justup.upme.launcher.LauncherAppWidgetHost;
import me.justup.upme.launcher.LauncherAppWidgetInfo;
...
import me.justup.upme.launcher.LauncherViewPropertyAnimator;
import me.justup.upme.launcher.PendingAddWidgetInfo;
import me.justup.upme.launcher.SearchDropTargetBar;
import me.justup.upme.launcher.ShortcutInfo;
import me.justup.upme.launcher.SmoothPagedView;
import me.justup.upme.launcher.Workspace;
...
public class LauncherActivity extends BaseActivity implements
    ...
    public static final int MENU_GROUP_WALLPAPER = 1;
    public static final int MENU_WALLPAPER_SETTINGS = Menu.FIRST + 1;
    public static final int MENU_MANAGE_APPS = MENU_WALLPAPER_SETTINGS + 1;
    public static final int MENU_SYSTEM_SETTINGS = MENU_MANAGE_APPS + 1;
    public static final int MENU_HELP = MENU_SYSTEM_SETTINGS + 1;
    ...
    public static final String FORCE_ENABLE_ROTATION_PROPERTY = "launcher_force_rotate";
    ...
    // Type: int
    public static final String RUNTIME_STATE_PENDING_ADD_CONTAINER = "launcher.add_container";
    // Type: int
    public static final String RUNTIME_STATE_PENDING_ADD_SCREEN = "launcher.add_screen";
    // Type: int
    public static final String RUNTIME_STATE_PENDING_ADD_CELL_X = "launcher.add_cell_x";
    // Type: int
    public static final String RUNTIME_STATE_PENDING_ADD_CELL_Y = "launcher.add_cell_y";
    // Type: boolean
    ...
    // Type: int
    public static final String RUNTIME_STATE_PENDING_ADD_SPAN_X = "launcher.add_span_x";
    // Type: int
    public static final String RUNTIME_STATE_PENDING_ADD_SPAN_Y = "launcher.add_span_y";
    // Type: parcelable
    public static final String RUNTIME_STATE_PENDING_ADD_WIDGET_INFO = "launcher.add_widget_info";

    public static final String TOOLBAR_ICON_METADATA_NAME = "com.android.launcher.toolbar_icon";
    public static final String TOOLBAR_SEARCH_ICON_METADATA_NAME = "com.android.launcher.toolbar_search_icon";
    public static final String TOOLBAR_VOICE_SEARCH_ICON_METADATA_NAME = "com.android.launcher.toolbar_voice_search_icon";
    ...
    public AnimatorSet mStateAnimation = null;
    public AnimatorSet mDividerAnimator = null;

    public static final int APPWIDGET_HOST_ID = 1024;
    public static final int EXIT_SPRINGLOADED_MODE_SHORT_TIMEOUT = 300;
    public static final int EXIT_SPRINGLOADED_MODE_LONG_TIMEOUT = 600;
    public static final int SHOW_CLING_DURATION = 550;
    public static final int DISMISS_CLING_DURATION = 250;

    public static final Object sLock = new Object();
    public static int sScreen = DEFAULT_SCREEN;

    // How long to wait before the new-shortcut animation automatically pans the workspace
    public static int NEW_APPS_ANIMATION_INACTIVE_TIMEOUT_SECONDS = 10;

    public final BroadcastReceiver mCloseSystemDialogsReceiver = new CloseSystemDialogsIntentReceiver();
    public final ContentObserver mWidgetObserver = new AppWidgetResetObserver();

    public LayoutInflater mInflater = null;

    public Workspace mWorkspace = null;
    public View mQsbDivider = null;
    public View mDockDivider = null;
    public View mLauncherView = null;
    public DragLayer mDragLayer = null;
    public DragController mDragController = null;

    public AppWidgetManager mAppWidgetManager = null;
    public LauncherAppWidgetHost mAppWidgetHost = null;

    public ItemInfo mPendingAddInfo = new ItemInfo();
    public AppWidgetProviderInfo mPendingAddWidgetInfo = null;

    public int[] mTmpAddItemCellCoordinates = new int[2];

    public FolderInfo mFolderInfo = null;

    public Hotseat mHotseat = null;
    public View mAllAppsButton = null;

    public SearchDropTargetBar mSearchDropTargetBar = null;
    public AppsCustomizeTabHost mAppsCustomizeTabHost = null;
    public AppsCustomizePagedView mAppsCustomizeContent = null;
    public boolean mAutoAdvanceRunning = false;

    public Bundle mSavedState = null;
    ...
    public static boolean sPausedFromUserAction = false;

    public Bundle mSavedInstanceState = null;

    public LauncherModel mModel = null;
    public IconCache mIconCache = null;
    ...
    public Intent mAppMarketIntent = null;

    // Related to the auto-advancing of widgets
    public final int ADVANCE_MSG = 1;
    public final int mAdvanceInterval = 20000;
    public final int mAdvanceStagger = 250;
    public long mAutoAdvanceSentTime;
    public long mAutoAdvanceTimeLeft = -1;
    public HashMap<View, AppWidgetProviderInfo> mWidgetsToAdvance = new HashMap<View, AppWidgetProviderInfo>();
    ...
    public static Drawable.ConstantState[] sGlobalSearchIcon = new Drawable.ConstantState[2];
    public static Drawable.ConstantState[] sVoiceSearchIcon = new Drawable.ConstantState[2];
    public static Drawable.ConstantState[] sAppMarketIcon = new Drawable.ConstantState[2];

    public Drawable mWorkspaceBackgroundDrawable = null;
    public Drawable mBlackBackgroundDrawable = null;
    ...
    public int mNewShortcutAnimatePage = -1;
    public ArrayList<View> mNewShortcutAnimateViews = new ArrayList<View>();
    public ImageView mFolderIconImageView = null;
    public Bitmap mFolderIconBitmap = null;
    public Canvas mFolderIconCanvas = null;
    public Rect mRectForFolderAnimation = new Rect();

    public BubbleTextView mWaitingForResume = null;

    public HideFromAccessibilityHelper mHideFromAccessibilityHelper = new HideFromAccessibilityHelper();
    ...
    public static ArrayList<PendingAddArguments> sPendingAddList = new ArrayList<PendingAddArguments>();
    ...
    private void checkForLocaleChange() {
        if (sLocaleConfiguration == null) {
            new AsyncTask<Void, Void, LocaleConfiguration>() {
                ...
                protected LocaleConfiguration doInBackground(Void... unused) {
                    ...
                    readConfiguration(LauncherActivity.this, localeConfiguration);
        ...
        if (localeChanged) {
            ...
            new Thread("WriteLocaleConfiguration") {
                @Override
                public void run() {
                    writeConfiguration(LauncherActivity.this, localeConfiguration);
                }
            }.start();
        }
    }
     ...
     * to run after other transitions. Spring loaded
     * mode
     */
    ...
    public void completeAddApplication(Intent data, long container, int screen, int cellX, int cellY) {
        ...
        if (info != null) {
            ...
            LOGE(TAG, "Couldn't find ActivityInfo for selected application : " + data);
        }
    }
    ...
    public static int[] getSpanForWidget(Context context, ComponentName component, int minWidth, int minHeight) {
            ...
            if (autoAdvanceRunning) {
                ...
                if (!mWidgetsToAdvance.isEmpty()) {
                    mAutoAdvanceTimeLeft = Math
                            .max(0, mAdvanceInterval - (System.currentTimeMillis() - mAutoAdvanceSentTime));
                }
    ...
    public void addAppWidgetImpl(final int appWidgetId, ItemInfo info, AppWidgetHostView boundWidget, AppWidgetProviderInfo appWidgetInfo) {
    ...
    public FolderIcon addFolder(CellLayout layout, long container, final int screen, int cellX, int cellY) {
        final FolderInfo folderInfo = new FolderInfo();
        folderInfo.title = getText(R.string.folder_name);

        LauncherModel.addItemToDatabase(LauncherActivity.this, folderInfo, container, screen, cellX, cellY, false);
    ...
    public void onClickAppMarketButton(View v) {
        if (mAppMarketIntent != null) {
            ...
            LOGE(TAG, "Invalid app market intent.");
        }
    }
    ...
    public boolean startActivitySafely(View v, Intent intent, Object tag) {
        ...
        try {
            ...
            Toast.makeText(this, R.string.activity_not_found, Toast.LENGTH_SHORT).show();
            LOGE(TAG, "Unable to launch. tag=" + tag + " intent=" + intent, e);
        }
    ...
    public void startActivityForResultSafely(Intent intent, int requestCode) {
        try {
            ...
            Toast.makeText(this, R.string.activity_not_found, Toast.LENGTH_SHORT).show();
            LOGE(TAG, "Launcher does not have the permission to launch "
                            + intent
                            + ". Make sure to create a MAIN intent-filter for the corresponding activity "
                            + "or use the exported attribute for this activity.",
                    e);
    ...
    public void openFolder(FolderIcon folderIcon) {
        ...
        if (folder.getParent() == null) {
            ...
            LOGI(TAG, "Opening folder (" + folder
        ...
        if (animated) {
            ...
            mStateAnimation.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (mWorkspace != null && !springLoaded && !JustUpApplication.isScreenLarge()) {
            ...
            if (delayAnim) {
                final ViewTreeObserver.OnGlobalLayoutListener delayedStart = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            if (!springLoaded && !JustUpApplication.isScreenLarge()) {
                // Hide the workspace scrollbar
                mWorkspace.hideScrollingIndicator(true);
                hideDockDivider();
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        if (!hasFocus) {
            ...
            // AllApps
            if(mWorkspace!=null) { // TODO NullPointerException: Attempt to invoke virtual method 'boolean me.justup.upme.launcher.Workspace.postDelayed(java.lang.Runnable, long)' on a null object reference at me.justup.upme.LauncherActivity.onWindowFocusChanged(LauncherActivity.java:2173)
    ...
    public void showHotseat(boolean animated) {
        if (!JustUpApplication.isScreenLarge()) {
            if (animated) {
    ...
    private Drawable getExternalPackageToolbarIcon(ComponentName activityName, String resourceName) {
        try {
            ...
            LOGE(TAG, "Failed to load toolbar icon; "
                    + activityName.flattenToShortString()
                    + " not found", e);
        } catch (Resources.NotFoundException nfe) {
            // This can happen if the activity defines an invalid drawable
            LOGE(TAG, "Failed to load toolbar icon from " + activityName.flattenToShortString(), nfe);
        }
        return null;
    }
    ...
    public void bindAppWidget(LauncherAppWidgetInfo item) {
        ...
        LOGD(TAG, "bindAppWidget: id=" + item.appWidgetId + " belongs to component " + appWidgetInfo.provider);
        ...
        LOGD(TAG, "bound widget id=" + item.appWidgetId + " in " + (SystemClock.uptimeMillis() - start) + "ms");
    ...
    public void dumpState() {
        LOGD(TAG, "BEGIN launcher2 dump state for launcher " + this);
        LOGD(TAG, "mSavedState=" + mSavedState);
        LOGD(TAG, "mWorkspaceLoading=" + mWorkspaceLoading);
        LOGD(TAG, "mRestoring=" + mRestoring);
        LOGD(TAG, "mWaitingForResult=" + mWaitingForResult);
        LOGD(TAG, "mSavedInstanceState=" + mSavedInstanceState);
        LOGD(TAG, "sFolders.size=" + sFolders.size());
        mModel.dumpState();
        ...
        LOGD(TAG, "END launcher2 dump state");
    }
    ...
    public static void dumpDebugLogsToConsole() {
        LOGD(TAG, "");
        LOGD(TAG, "*********************");
        LOGD(TAG, "Launcher debug logs: ");

        for (int i = 0; i < sDumpLogs.size(); i++) {
            LOGD(TAG, "  " + sDumpLogs.get(i));
        }
    ...
    public interface LauncherTransitionable {
        ...
        void onLauncherTransitionPrepare(LauncherActivity l, boolean animated, boolean toWorkspace);

        void onLauncherTransitionStart(LauncherActivity l, boolean animated, boolean toWorkspace);

        void onLauncherTransitionStep(LauncherActivity l, float t);

        void onLauncherTransitionEnd(LauncherActivity l, boolean animated, boolean toWorkspace);
    }
    ...
    */
    ...
    public void onDestroy() {
        ...
        JustUpApplication app = ((JustUpApplication) getApplication());
        if(mModel!=null) {
            mModel.stopLoader();
        }
    ...
    protected void onCreateLA(Bundle savedInstanceState) {
        ...
        mSharedPrefs = getSharedPreferences(
                JustUpApplication.getSharedPreferencesKey(),
    ...
    protected void onActivityResultLA(final int requestCode, final int resultCode, final Intent data) {
    ...
    protected void onPauseLA() {
        mPaused = true;
        mDragController.cancelDrag();
        mDragController.resetLastGestureUpTime();
    }

    protected void onSaveInstanceStateLA(Bundle outState) {
