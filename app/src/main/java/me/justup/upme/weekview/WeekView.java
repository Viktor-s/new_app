...
//                    mCurrentFlingDirection = Direction.HORIZONTAL;
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
            ...
            ViewCompat.postInvalidateOnAnimation(me.justup.upme.weekview.WeekView.this);
            return true;
        }
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            if (mEventRects == null || mRefreshEvents || (dayNumber == leftDaysWithGaps + 1 && day.get(Calendar.DAY_OF_MONTH) == 15)) {
                getMoreEvents(day);
...
//                    return String.format("%02d %s", hour, amPm);
    ...
    /**
     * <b>Note:</b> Use {@link #setDateTimeInterpreter(me.justup.upme.weekview.DateTimeInterpreter)} and
     ...
     * <p>
     * <b>Note:</b> Use {@link #setDateTimeInterpreter(me.justup.upme.weekview.DateTimeInterpreter)} instead.
     * </p>
     *
     * @param length Supported values are {@link me.justup.upme.weekview.WeekView#LENGTH_SHORT} and
     *               {@link me.justup.upme.weekview.WeekView#LENGTH_LONG}.
     */
    @Deprecated
